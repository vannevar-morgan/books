...
class Frame_Pic : public Pic_base{
  ...
  static const char corner_char = '@'; // corner character
  static const char tb_char = '^'; // top and bottom character
  static const char l_char = '>'; // left character
  static const char r_char = '<'; // right character
