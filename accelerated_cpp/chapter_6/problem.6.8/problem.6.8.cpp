...
vector<Student_info>
extract_didnt(vector<Student_info>& students);
*/

vector<Student_info>
classify(vector<Student_info>& students, bool classifier(const Student_info&));
...
int main()
{
  ...
  // extract the students who didn't do all their homework
  ...
  vector<Student_info> failing_students = classify(all_students, pgrade);
...
classify(vector<Student_info>& students, bool classifier(const Student_info&))
{
  ...
  vector<Student_info> classified_false(iter, students.end());
  students.erase(iter, students.end());
  return classified_false;
}
