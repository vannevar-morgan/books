...
int main()
{
  ...
  list<Student_info> f_students = extract_fails(students);
  clock_t t_end = clock();
  ...
  cout << "\ntime to extract failing students using list: " << elapsed_secs << endl;
  cout << "total runtime using list: " << prog_elapsed << endl;
